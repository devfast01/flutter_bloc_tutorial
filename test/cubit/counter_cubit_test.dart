...
import 'package:flutter_block_tutorials/tutorial_3/cubit/counter_cubit.dart';
...
void main() {
  group('CounterCubit', () {
    ...
    blocTest(
      ...
      expect: () => [CounterState(counterValue: 1, wasInremented: true)],
    );
    ...
    blocTest(
      ...
      expect: () => [CounterState(counterValue: -1, wasInremented: false)],
    );
  });
}
