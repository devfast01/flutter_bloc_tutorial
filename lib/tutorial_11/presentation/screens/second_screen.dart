...
class SecondScreen11 extends StatefulWidget {
  SecondScreen11({Key? key, required this.title, required this.color})
      : super(key: key);
  ...
  @override
  SecondScreen11State createState() => SecondScreen11State();
}

class SecondScreen11State extends State<SecondScreen11> {
